...
class AppColors {
  ...
  static const Color categoryBorderColor = Color(0xFFF0F0F0);
  ...
  static const Color errorColor = Color(0xFFED2241);
  ...
  static const Color brown = Color(0xFF6B4918);
  static const Color lightOrange = Color(0xFFFFF3E2);
  static const Color mediumOrange = Color(0xFFF8D7A7);
  static const Color regularGray = Color(0xFF424242);
  static const Color subtitleColor = Color(0xFF8E9EB0);
  static const Color subServiceTitleColor = Color(0xFF1A1D1F);
  static const Color dividerColor1 = Color(0xFFB4BECB);
  ...
  static Color borderLightBlue = '#F3F3F3'.colorFromString;
  ...
  static Color splashLinearGradientColor2 =
      const Color.fromRGBO(245, 249, 254, 0.06);
  static Color splashLinearGradientColor3 = Colors.white.withOpacity(0);
  ...
  static const Color unSelectedBorderColor = Color(0xFFEAEAEA);
  static const Color gradientColor1 = Color(0xFF3F3F3F);
  static const Color dividerTabColor = Color(0xFFF5F5F5);
  static const Color shadowColor1 = Color(0xFF8585A3);
  static const Color shadowColor2 = Color(0xFF3B71FE);
  static const Color selectedTime = Color(0xFFFEEABC);
  static const Color blueDark = Color(0xFF14355B);

  static const Color borderColor2 = Color(0xFF6096BA);
  static const Color darkBlueColor = Color(0xFF1A1B2D);
  static const Color regularBlackColor = Color(0xFF272B30);
  ...
  static const Color dimGray = Color(0xFF717171);

  static const Color yellow = Color(0xFFFE8C00);

  static const Color borderDarkColor2 = Color(0xFFD1D3D4);
  ...
  static const Color shadowColor = Color(0xFFF4F4F4);

  static const Color dynamicGray = Color(0xFF3E3E3E);

  static const Color secondBackGroundColor = Color(0xFFF6FAFF);
  static const Color backGroundColor = Color(0xFFF9F9F9);

  static const Color unSelectedIndicatoColor = Color(0xFFB6BAC8);
  static const Color shadow = Color(0xFFFCFCFC);

  static const Color unselectedColor = Color(0xFF8A8A8A);
